	...
	<div class=" page-content clearfix">
		<div id="products_style">
				...
				<ul class="search_content clearfix">
					<form action="index" method="post">
						<li><input name="txt" type="text" class="text_add"
							placeholder="输入商品名称" style="width: 250px" /></li>
			...
			<div class="border clearfix">
				<span class="l_f"> <a onclick="member_add('新增','1000','800')"
					title="新增商品" class="btn btn-warning Order_form"><i
	...
	<tbody>
    	<c:forEach items="${requestScope.list}" var="r">
							<tr>
								...
								<img src="${r.pic}" height="60" width="40">
								</c:if>
								</td>
								
								<td>${r.comments}</td>
								<td class="td-manage"><a title="编辑"
									onclick="member_edit('编辑','${r.id}','1000','800')"
